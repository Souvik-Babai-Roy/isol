<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="Category_master.aspx.vb" Inherits="_Default" %>
                            ...
                            <div class="forms-sample">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <asp:Label ID="Label23" runat="server" class="col-sm-2 col-form-label" Text="Product Category"
                                                        AssociatedControlID="txtcatname"></asp:Label>
                                                    <div class=" col-sm-10">
                                                        <asp:TextBox ID="txtcatname" runat="server" class="form-control text-blue input-radius"
                                                            placeholder="Category Name" ValidationGroup="entry"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class=" col-sm-10">
                                                        <asp:TextBox class="form-control text-blue" ID="txtremarks" runat="server" placeholder="Remarks"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div align="center">
                                    <button type="submit" class="btn btn-primary btn-block text-bold" id="btnsave" runat="server"
                                        ...
                                        <i class="fas fa-plus-square"></i>&nbsp; Add Product Category
                                    </button>
                                    <button type="submit" class="btn btn-secondary btn-block text-bold" id="btnupdate"
                                        runat="server" visible="False">
                                        <i class="fas fa-edit"></i>&nbsp; Update Product Category
                                    </button>
                        ...
                        <div class="card-body">
                            <div class="forms-sample">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <asp:Label ID="Label18" runat="server" class="col-sm-2 col-form-label" Text="Category Name/ID"
                                                AssociatedControlID="txtsearchname"></asp:Label>
                                            <div class=" col-sm-10">
                                                <asp:TextBox ID="txtsearchname" placeholder="Category Name (ID for Update)" class="form-control"
                                ...
                                <div>
                                    ...
                                    <div class="" align="center">
                                        <button type="Submit" id="btnsearch" class="btn btn-info btn-block text-bold" runat="server"
                                            ...
                                            <i class="fas fa-search"></i>&nbsp; Search With Category Name</button>
